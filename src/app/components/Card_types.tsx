    ...
    <div className="bg-gray-300 shadow-md rounded-lg flex-grow overflow-hidden mb-5 md:mb-0 hover:border-blue-500 hover:border-2  cursor-pointer">
      <div className="flex justify-between items-center w-full mx-auto">
        ...
        <div className="w-[40%] ml-10 ">
          <h3 className="text-xl font-bold text-zinc-800 dark:text-white font-nunito-extra-bold">{name}</h3>
          <p className="text-gray-700 dark:text-zinc-300">{descripcion}</p>
        </div>
        {/* Imagen a la derecha */}
  ...
  return (
    <div className="w-full min-h-[300px] cursor-pointer  bg-white dark:bg-zinc-900  hover:border-blue-500 hover:border-2 p-6 rounded-2xl shadow-[0px_4px_12px_rgba(0,0,0,0.1)] hover:shadow-[0px_8px_16px_rgba(0,0,0,0.2)] transition duration-300 flex items-center mb-5 md:mb-0 ">
      ...
      <div className="w-[50%] p-4">
        <h3 className="text-xl font-bold text-zinc-800 dark:text-white font-nunito-extra-bold">{name}</h3>
        <p className="mt-2 text-zinc-600 dark:text-zinc-300">{descripcion}</p>
        {link && (
          <a
            href={link}
            target="_blank"
